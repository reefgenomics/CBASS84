...
de.in=read.table("./outputs/CBASS84_noConta_raw.txt", header = TRUE, row.names = 1) 
colnames(de.in)=gsub('\\.', '-', colnames(de.in))
met=read.table("./Input_files/metadata.txt", header = TRUE, row.names = 1)
...
E.30.33.res$Comparison="Eilat 30 vs 33"
...
E.30.36.res$Comparison="Eilat 30 vs 36"
...
E.33.36.res$Comparison="Eilat 33 vs 36"
...
K.30.33.res$Comparison="Kaust 30 vs 33"
...
K.30.36.res$Comparison="Kaust 30 vs 36"
...
K.33.36.res$Comparison="Kaust 33 vs 36"
...
message("Number of DA OTUs in Eilat 30 vs 33: ", nrow(E.30.33.res), ". More abundant: ", nrow(subset(E.30.33.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(E.30.33.res, log2FoldChange <0 )))
message("Number of DA OTUs in Eilat 30 vs 36: ", nrow(E.30.36.res), ". More abundant: ", nrow(subset(E.30.36.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(E.30.36.res, log2FoldChange <0 )))
message("Number of DA OTUs in Eilat 33 vs 36: ", nrow(E.33.36.res), ". More abundant: ", nrow(subset(E.33.36.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(E.33.36.res, log2FoldChange <0 )))

message("Number of DA OTUs in Kaust 30 vs 33: ", nrow(K.30.33.res), ". More abundant: ", nrow(subset(K.30.33.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(K.30.33.res, log2FoldChange <0 )))
message("Number of DA OTUs in Kaust 30 vs 36: ", nrow(K.30.36.res), ". More abundant: ", nrow(subset(K.30.36.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(K.30.36.res, log2FoldChange <0 )))
message("Number of DA OTUs in Kaust 33 vs 36: ", nrow(K.33.36.res), ". More abundant: ", nrow(subset(K.33.36.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(K.33.36.res, log2FoldChange <0 )))
...
message("Number of DA OTUs in T30 Eilat vs KAUST: ", nrow(T30.E.K.res), ". More abundant: ", nrow(subset(T30.E.K.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T30.E.K.res, log2FoldChange <0 )))
message("Number of DA OTUs in T30 Eilat vs Exposed: ", nrow(T30.E.X.res), ". More abundant: ", nrow(subset(T30.E.X.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T30.E.X.res, log2FoldChange <0 )))
message("Number of DA OTUs in T30 Eilat vs Protected: ", nrow(T30.E.P.res), ". More abundant: ", nrow(subset(T30.E.P.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T30.E.P.res, log2FoldChange <0 )))
message("Number of DA OTUs in T30 KAUST vs Exposed: ", nrow(T30.K.X.res), ". More abundant: ", nrow(subset(T30.K.X.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T30.K.X.res, log2FoldChange <0 )))
message("Number of DA OTUs in T30 KAUST vs Protected: ", nrow(T30.K.P.res), ". More abundant: ", nrow(subset(T30.K.P.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T30.K.P.res, log2FoldChange <0 )))
...
message("Number of DA OTUs in T33 Eilat vs KAUST: ", nrow(T33.E.K.res), ". More abundant: ", nrow(subset(T33.E.K.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T33.E.K.res, log2FoldChange <0 )))
message("Number of DA OTUs in T33 Eilat vs Exposed: ", nrow(T33.E.X.res), ". More abundant: ", nrow(subset(T33.E.X.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T33.E.X.res, log2FoldChange <0 )))
message("Number of DA OTUs in T33 Eilat vs Protected: ", nrow(T33.E.P.res), ". More abundant: ", nrow(subset(T33.E.P.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T33.E.P.res, log2FoldChange <0 )))
message("Number of DA OTUs in T33 KAUST vs Exposed: ", nrow(T33.K.X.res), ". More abundant: ", nrow(subset(T33.K.X.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T33.K.X.res, log2FoldChange <0 )))
message("Number of DA OTUs in T33 KAUST vs Protected: ", nrow(T33.K.P.res), ". More abundant: ", nrow(subset(T33.K.P.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T33.K.P.res, log2FoldChange <0 )))
...
message("Number of DA OTUs in T36 Eilat vs KAUST: ", nrow(T36.E.K.res), ". More abundant: ", nrow(subset(T36.E.K.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T36.E.K.res, log2FoldChange <0 )))
message("Number of DA OTUs in T36 Eilat vs Exposed: ", nrow(T36.E.X.res), ". More abundant: ", nrow(subset(T36.E.X.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T36.E.X.res, log2FoldChange <0 )))
message("Number of DA OTUs in T36 Eilat vs Protected: ", nrow(T36.E.P.res), ". More abundant: ", nrow(subset(T36.E.P.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T36.E.P.res, log2FoldChange <0 )))
message("Number of DA OTUs in T36 KAUST vs Exposed: ", nrow(T36.K.X.res), ". More abundant: ", nrow(subset(T36.K.X.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T36.K.X.res, log2FoldChange <0 )))
message("Number of DA OTUs in T36 KAUST vs Protected: ", nrow(T36.K.P.res), ". More abundant: ", nrow(subset(T36.K.P.res, log2FoldChange >0 )), ". Less abundant: ", nrow(subset(T36.K.P.res, log2FoldChange <0 )))
