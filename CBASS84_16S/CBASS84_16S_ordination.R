...
#data in
otu.2=read.table("./outputs/CBASS84_noConta_raw.txt", header = TRUE, row.names = 1)[,1:84]
...
map$ID=rownames(map)
map$Region=factor(map$Region, levels = c("ICN", "Al Fahal", "Exposed Site Tahala","Protected Site Tahala"))
